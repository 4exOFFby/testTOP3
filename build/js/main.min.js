...
/* harmony import */ var _modules_check_form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/check-form */ "./js/modules/check-form.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_check_form__WEBPACK_IMPORTED_MODULE_0__["checkForm"])();
  });
});
...
var checkForm = function checkForm() {
  var formSection = document.querySelector('.sign-up');
  var form = document.querySelector('[data-form="form"]');
  var firstName = document.querySelector('[data-form="firstName"]');
  var lastName = document.querySelector('[data-form="lastName"]');
  var email = document.querySelector('[data-form="email"]');
  var password = document.querySelector('[data-form="password"]');
  var confirmPassword = document.querySelector('[data-form="confirm-password"]');
  var firstNameLabel = document.querySelector('[data-form="firstNameLabel"]');
  var lastNameLabel = document.querySelector('[data-form="lastNameLabel"]');
  var emailLabel = document.querySelector('[data-form="emailLabel"]');
  var passwordLabel = document.querySelector('[data-form="passwordLabel"]');
  var confirmPasswordLabel = document.querySelector('[data-form="confirmPasswordLabel"]');
